package com.dezuani.fabio.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.dezuani.fabio.IntegrationTest;
import com.dezuani.fabio.repository.timezone.DateTimeWrapper;
import com.dezuani.fabio.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    @Value("${spring.jpa.properties.hibernate.jdbc.time_zone:UTC+1}")
